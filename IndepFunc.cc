...
TH1D* IndepFunc( )
{
  ...
  for(int ihist = 0; ihist < numhistos; ihist++){
    ...
    TF1 *f = new TF1("f", "([0]*[36]*[36] + [1]*[36] + [2]) * exp(-0.5 * ( (x - ([3]*[36]*[36] + [4]*[36] + [5]) ) / ([6]*[36]*[36] + [7]*[36] + [8]) )^2) + ([9]*[36]*[36] + [10]*[36] + [11]) * exp(-0.5 * ( (x - ([12]*[36]*[36] + [13]*[36] + [14]) ) / ([15]*[36]*[36] + [16]*[36] + [17]) )^2) + ([18]*[36]*[36] + [19]*[36] + [20]) * exp(-0.5 * ( (x - ([21]*[36]*[36] + [22]*[36] + [23]) ) / ([24]*[36]*[36] + [25]*[36] + [26]) )^2) + ([27]*[36]*[36] + [28]*[36] + [29]) * exp(-0.5 * ( (x - ([30]*[36]*[36] + [31]*[36] + [32]) ) / ([33]*[36]*[36] + [34]*[36] + [35]) )^2)", -10, 100);
