// g++ -g -std=c++1y -o rooFit_test.exe rooFit_test.cpp `root-config --cflags --libs` -I$RATROOT/include/libpq -I$RATROOT/include -I$RATROOT/include/external -L$RATROOT/lib -lRATEvent_Linux -lRooFitCore
