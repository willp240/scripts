...
def pycondor_submit(job_batch, job_id, macro_path, run_path, rat_env, sub_path, out_dir, infilename, sleep_time = 1, priority = 5):
    '''
    ...
    out_submit_text = "executable              = "+str(sh_filepath)+"\n"+\
                     ...
                     "getenv                  = "+str(getenv)+"\n"+\
                     "transfer_input_files    = "+str(infilename)+"\n"+\
