...
void CompareFitPerformance( std::string fname_1_2p5, std::string fname_2_2p5, std::string fname_1_1to10, std::string fname_2_1to10, std::string label1, std::string label2, std::string canv_name ) {
  ...
  double r_2p5_ymax[8] = {30, 120, 30, 120, 30, 120, 75, 100};
  ...
  double r_1to10_ymax[8] = {30, 120, 30, 120, 30, 120, 100, 100};
  ...
  double e_1to10_ymax[8] = {30, 100, 30, 100, 30, 100, 60, 120};
  ...
  MakeCanvas( r_2p5_filename1, r_2p5_filename2, label1, label2, r_2p5_ymax, r_2p5_ymin, r_line, r_2p5_cname);
  MakeCanvas( r_1to10_filename1, r_1to10_filename2, label1, label2, r_1to10_ymax, r_1to10_ymin, r_line, r_1to10_cname);
  MakeCanvas( e_1to10_filename1, e_1to10_filename2, label1, label2, e_1to10_ymax, e_1to10_ymin, e_line, e_1to10_cname);

}


void MakeCanvas( std::string filename1, std::string filename2, std::string label1, std::string label2, double ymax[8], double ymin[8], TLine* line, std::string canvas_name ) {
