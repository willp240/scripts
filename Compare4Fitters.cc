...
void MakeCanvas( std::string, std::string, std::string, std::string, std::string, std::string, std::string, std::string, double[8], double[8], TLine*, std::string );

void CompareFitPerformance( std::string fname_1_2p5, std::string fname_2_2p5, std::string fname_3_2p5, std::string fname_4_2p5, std::string fname_1_1to10, std::string fname_2_1to10, std::string fname_3_1to10, std::string fname_4_1to10, std::string label1, std::string label2, std::string label3, std::string label4, std::string canv_name ) {
  ...
  //double r_2p5_ymax[8] = {30, 250, 30, 250, 100, 250, 100, 250};
  //double r_2p5_ymin[8] = {-30, 0, -30, 0, -100, 0, -100, 0};
  ...
  //double r_1to10_ymax[8] = {30, 250, 30, 250, 100, 250, 100, 250};
  //double r_1to10_ymin[8] = {-30, 0, -30, 0, -100, 0, -100, 0};
  //double e_1to10_ymax[8] = {30, 250, 30, 250, 100, 250, 100, 250};
  //double e_1to10_ymin[8] = {-30, 0, -30, 0, -100, 0, -100, 0};
  ...
  MakeCanvas( r_2p5_filename1, r_2p5_filename2, r_2p5_filename3, r_2p5_filename4, label1, label2, label3, label4, r_2p5_ymax, r_2p5_ymin, r_line, r_2p5_cname);
  MakeCanvas( r_1to10_filename1, r_1to10_filename2, r_1to10_filename3, r_1to10_filename4, label1, label2, label3, label4, r_1to10_ymax, r_1to10_ymin, r_line, r_1to10_cname);
  MakeCanvas( e_1to10_filename1, e_1to10_filename2, e_1to10_filename3, e_1to10_filename4, label1, label2, label3, label4, e_1to10_ymax, e_1to10_ymin, e_line, e_1to10_cname);

}


void MakeCanvas( std::string filename1, std::string filename2, std::string filename3, std::string filename4, std::string label1, std::string label2, std::string label3, std::string label4, double ymax[8], double ymin[8], TLine* line, std::string canvas_name ) {
