...
ROOT_DIRNAME=root
ROOT_NEWNAME=root-5.34.38
ROOT_PATH=~/temp_Will/$ROOT_DIRNAME

# Set up the directory structure
#mkdir -p ./cvmfs/sl7/sw/dependencies/$ROOT_NEWNAME

# Copy root to this new path, and rename it
#cp -r ${ROOT_PATH}/. ./cvmfs/sl7/sw/dependencies/$ROOT_NEWNAME
