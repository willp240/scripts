...
if __name__ == "__main__":
    ...
    parser.add_argument("-b", "--input_files_basename", type=str,
                        default="input_dir_basename",
                        help="basename of input files")
...
#    condor_dir = check_dir(condor_directory)
    ...
    inbase_name = args.input_files_basename
    ...
    for in_name in os.listdir(in_dir): # range(args.no_sims):
        ...
        pycondor_submit(batch_id,job_id,"{0}{1}_reproc.mac".format(mac_dir,in_name),args.run_directory,args.env_file,args.submission_directory,out_dir, sleep_time = 1, priority = 5)
        i = i+1
