...
{ 
  ...
  fnames.push_back("/data/snoplus3/parkerw/ratSimulations/Apr15_SEV_NoInterp5MeV/*.root");
  fnames.push_back("/data/snoplus3/parkerw/ratSimulations/Apr15_SEV_NoInterp7.5MeV/*.root");
  fnames.push_back("/data/snoplus3/parkerw/ratSimulations/Apr15_SEV_NoInterp10MeV/*.root");

  std::vector<std::string> flabels;
  flabels.push_back("2.5 MeV");
  flabels.push_back("5.0 MeV");
  flabels.push_back("7.5 MeV");
  flabels.push_back("10.0 MeV");
  ...
  for (int i = 0; i<fnames.size(); i++){
    ...
    hHitTimeResiduals->GetYaxis()->SetTitleOffset(1.27);
