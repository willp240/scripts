...
if [ $MYBASE == "SL7" ]; then
  ...
  export RATROOT=/home/parkerw/Software/rat_fresh
...
#export ROOTSYS=$SNOCAVE/root_build_6.24.02
#source /data/snoplus/software/snocave_CentOS7/root_build_6.24.02/bin/thisroot.sh
