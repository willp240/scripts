...
void PlotTResid(){
  ...
  TFile *_file1 = TFile::Open("/home/parkerw/Software/rat_master/example/root/eav_thitpmtz.root");
  ...
  TFile *_file2 = TFile::Open("/home/parkerw/Software/rat_master/example/root/eneck_thitpmtz.root");
