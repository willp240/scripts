...
{ 
  ...
  flabels.push_back("10 MeV -0.5 ns");
  flabels.push_back("10 MeV, -0.5 ns, 183.71 mm/ns");
  flabels.push_back("10 MeV, 183.71 mm/ns");
  flabels.push_back("10 MeV, -0.5 ns,183.71 mm/ns");
  ...
  TLegend* leg = new TLegend(0.55, 0.6, 0.88, 0.85);
  ...
  for (int i = 0; i<fnames.size(); i++){
    ...
    if(i==1)
      hHitTimeResiduals->SetLineColor(3);
    if(i==2)
      hHitTimeResiduals->SetLineColor(5);
